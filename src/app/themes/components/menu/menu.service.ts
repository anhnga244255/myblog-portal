...
export class MenuService {
  ...
  protected _prepareItem(object: any): any {
    if (!object.skip) {
      ...
      if (object.route.path) {
        itemUrl = this._router.serializeUrl(this._router.createUrlTree(object.route.paths));
        // object.url = object.url ? object.url : '#' + itemUrl;
        object.url = object.url ? object.url :  itemUrl;
      } else if (object.route.url) {
        itemUrl = this._router.serializeUrl(this._router.createUrlTree(object.route.url));
        // object.url = object.url ? object.url : '#' + itemUrl;
        object.url = object.url ? object.url : itemUrl;
      }
