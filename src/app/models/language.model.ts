...
export class LanguageModel extends BaseModel {
  ...
  public initValidateRules(): ValidateModel {
    ...
    this.addRule('code', 'required', true, this._t('Code can not be blank.'));
    this.addRule('code', 'maxLength', INPUT_MAXLENGTH, this._t(`Maximum {0} characters.`, INPUT_MAXLENGTH));

    return this.getRules();
  }
  public static toRequest(data: LanguageModel): LanguageModel {
    let model: any = {};
